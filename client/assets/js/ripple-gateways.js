...
var Gateways={
	...
	rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B:{
		...
		ripplename:'~Bitstamp',
		currencies:'BTC, USD',
		weburl:'http://www.bitstamp.net/',
		hotaddress:["rrpNnNLKrartuEqfJGpqyDwPj1AFPg9vn1"],
	},
	rLEsXccBGNR3UPuPu2hUXPjziKC3qKSBun:{
		name:'The Rock',
		ripplename:'~therock',
		currencies:'BTC,LTC,NMC,PPC,DOGE,EUR,USD',
		weburl:'https://www.therocktrading.com/',
		hotaddress:["rUeFPRGNjtcbtezyQKKiDcS1eQyYLQ1gcr"]
	},
	r9Dr5xwkeLegBeXq6ujinjSBLQzQ1zQGjH:{
		name:'Ripple Singapore',
		ripplename:' ~RippleSingapore',
		currencies:'SGD, USD, XAG, XAU, XPT',
		weburl:'https://www.ripplesingapore.com',
		hotaddress:["rL4A1qbTkrJXT644gyzmLVk6uudyMagJ9Q"]
	},
	r3ADD8kXSUKHd6zTCKfnKT3zV9EZHjzp1S:{
		name:'TRipple Union',
		ripplename:'~RippleUnion',
		currencies:'CAD',
		weburl:'https://rippleunion.com/',
		hotaddress:[],
	},
	rMAz5ZnK73nyNUL4foAvaxdreczCkG3vA6:{
		name:'Trade Japan',
		ripplename:'~RippleTradeJapan',
		currencies:'JPY',
		weburl:'http://rippletrade.jp/',
		hotaddress:["r3bStftDydy4dKEUBc9YMabTTk98uZzMpF"]
	},
	r94s8px6kSw1uZ1MV98dhSRTvc6VMPoPcN:{
		name:'Tokyo JPY Issuer',
		ripplename:'~tokyojpy',
		currencies:'JPY',
		weburl:'http://tokyojpy.com/',
		hotaddress:[]
	},
	rrh7rf1gV2pXAoqA8oYbpHd8TKv5ZQeo67:{
		name:'TGold Bullion International',
		ripplename:'~GBI',
		currencies:'XAU',
		weburl:'http://www.bullioninternational.com/',
		hotaddress:[],
	},
 	rfNZPxoZ5Uaamdp339U9dCLWz2T73nZJZH:{
		...
		ripplename:'~rippex',
		currencies:'BRL',
		weburl:'https://rippex.net',
		hotaddress:[],
	},
	rNPRNzBB92BVpAhhZr4iXDTveCgV5Pofm9:{
		name:'Payroutes',
		ripplename:'~PayRoutes',
		currencies:'USD, ILS, BTC, LTC, NMC, PPC',
		weburl:'https://payroutes.com/',
		hotaddress:[
	...
	rBadiLisPCyqeyRA1ufVLv5qgVRenP2Zyc:{
		name:'Panama Bitcoins',
		ripplename:'~ptycoin',
		currencies:'USD, PAB, BTC, LTC, DRK',
		weburl:'http://ptycoin.com/ripple',
		hotaddress:[],
	},
	...
	r9ZFPSb1TFdnJwbTMYHvVwFK1bQPUCVNfJ:{
		name:'Ripplex',
		ripplename:'~ripplex-llp',
		currencies:'JPY',
		weburl:'https://ripplex.co.jp',
		hotaddress:[],
	},
 	rpDMez6pm6dBve2TJsmDpv7Yae6V5Pyvy2:{
		...
		ripplename:'~LakeBTC',
		currencies:'USD',
		weburl:'https://www.lakebtc.com/',
		hotaddress:[],
	},
	rB1ggHi4fMhXpMYWcjBpLUJGFDTz7j5QZn:{
		name:'Ripple Central 24',
		ripplename:'~central24japan',
		currencies:'JPY',
		weburl:'http://ripplecentral24.jp',
		hotaddress:[],
	},
